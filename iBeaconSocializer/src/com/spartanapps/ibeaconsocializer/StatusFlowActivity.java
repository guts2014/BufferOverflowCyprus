...
public class StatusFlowActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Check for WiFi or 3g and pop up network settings if not available +Bluetooth
		...
		//Boolean isBluetooth=manager.getNetworkInfo(ConnectivityManager.TYPE_BLUETOOTH).isAvailable();
		//Enables Bluetooth
