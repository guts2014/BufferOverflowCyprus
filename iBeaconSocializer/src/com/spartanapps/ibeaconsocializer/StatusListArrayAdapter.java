...
public class StatusListArrayAdapter extends ArrayAdapter<StatusFlowItem> {
  ...
  public StatusListArrayAdapter(Context context,int resource, List<StatusFlowItem> myvalues) {
  ...
  public View getView(final int position, View convertView, ViewGroup parent) {
      ...
      rowView.setOnClickListener(new OnClickListener(){
		...
		public void onClick(View arg0) {
			...
			Toast.makeText(context, values.get(position).getStatus(), Toast.LENGTH_SHORT).show();
		}
